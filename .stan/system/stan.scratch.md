...
- Ensure context-mode orchestration and related wrappers surface deterministic selection metadata via `onSelectionReport` (pass-through to underlying archive APIs).
